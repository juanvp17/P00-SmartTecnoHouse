...
// Clase concreta para el Sensor de Luz. Aquí definimos el comportamiento de un tipo de sensor en concreto
...
public class SensorLuz extends Sensor {
    ...
    public void actualizarValor(JSONArray datosJSON){
        ...
        // Comprobamos que los datos no vengan vacíos. De ser así, evaluamos una condición para ver que los datos no sean irreales o desproporcionados (por ejemplo, -10 lux)

        if (datos!= null) {

            double valorLeido = datos.getDouble("value");

            if (valorLeido >= 0.0 && valorLeido <= 500.0) {
